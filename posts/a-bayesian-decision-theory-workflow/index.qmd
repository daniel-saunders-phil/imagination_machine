...
To find the optimal price, we need to do a few things. Each of the things shows off a different way to reuse-while-modifying model components. I should mention, I borrowed heavily from this [workshop](https://www.youtube.com/watch?v=boB16AX0OLw) by Ricardo Vieira and Jesse Grabowski.
