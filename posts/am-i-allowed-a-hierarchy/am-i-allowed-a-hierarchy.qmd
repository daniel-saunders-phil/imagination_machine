...
for i in range(15):
    dot.node(name=names[i],label=names[i][0],penwidth='0')

dot.attr('edge',arrowhead='none')
dot.edge(' 0','R11','3/5')
dot.edge(' 0','B11','2/5')
dot.edge('R11','R21','2/4')
dot.edge('R11','B21','2/4')
dot.edge('B11','R22','3/4')
dot.edge('B11','B22','1/4')
dot.edge('R21','R31','1/3')
dot.edge('R21','B31','2/3')
dot.edge('B21','R32','2/3')
dot.edge('B21','B32','1/3')
dot.edge('R22','R33','2/3')
dot.edge('R22','B33','1/3')
dot.edge('B22','R34','2/3')
dot.edge('B22','B34','1/3')
dot
```
...
## From exchangeability to hierarchical modeling: de Finnetti's Theorem

The notion of exchangeability tells us the class of random variables out of which we can construct hierarchies. But how does that process work? The engine is de Finnetti's theorem. The theorem is best illustrated through a lovely statistical engine: Polya's Urn[^9].
...
dot.edge(' 0','R11','2/3')
dot.edge(' 0','B11','1/3')
dot.edge('R11','R21','3/4')
dot.edge('R11','B21','1/4')
dot.edge('B11','R22','2/4')
dot.edge('B11','B22','2/4')
dot.edge('R21','R31','4/5')
dot.edge('R21','B31','1/5')
dot.edge('B21','R32','3/5')
dot.edge('B21','B32','2/5')
dot.edge('R22','R33','3/5')
dot.edge('R22','B33','2/5')
dot.edge('B22','R34','2/5')
dot.edge('B22','B34','3/5')
dot
```

Notice that it has the same kind of left-right symmetry that drawing without replacement had. This process is exchangeable. One key difference between Polya's urn and sampling without replacement is this new process is also infinite. If I take balls out, eventually, I run out. But if I keep putting balls in, Polya's urn keeps giving. De Finnetti's representation theorem only applies to *infinite* exchangeable processes.
...
It's also notable that, although very simple, this is a hierarchical model. There is an underlying, shared property and each particular random variable depends, somewhat, on that property. What's powerful is that De Finnetti's theorem holds for any infinite exchangeable sequence of random variables. It doesn't have to be Polya's urn. If you have an exchangeable process, there must exist a hierarchical model to describe it. This is your license to build.
