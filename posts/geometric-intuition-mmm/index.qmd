...
date: 2025-04-21
toc: true
description: "Not just fancy linear regressions."
execute:
  echo: false
format:
  html:
...
[A common choice](https://www.pymc-marketing.io/en/stable/api/generated/pymc_marketing.mmm.transformers.tanh_saturation.html#pymc_marketing.mmm.transformers.tanh_saturation) of saturation function is the tanh.
...
ax[1].plot(b,lam,'o')
ax[1].annotate("true parameter value", (b,lam), xytext=(10,10), textcoords='offset points', fontsize=8)
ax[1].set_xlabel("b (saturation point)")
